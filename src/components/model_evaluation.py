...
from src.entity.s3_estimator import Proj2Estimator
...
class ModelEvaluation:
    ...
    def get_best_model(self) -> Optional[Proj2Estimator]:
        """
        ...
        try:
            ...
            proj2_estimator = Proj2Estimator(bucket_name=bucket_name,
                                               model_path=model_path)

            if proj2_estimator.is_model_present(model_path=model_path):
                return proj2_estimator
            return None
        except Exception as e:
